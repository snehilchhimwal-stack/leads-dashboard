...
| **Last Verified** | 2026-09-26 against commit `SHA_PLACEHOLDER` — checkpoint emails list only unresolved leads and are skipped when nothing is unresolved (see `## Version / change reference`) |
