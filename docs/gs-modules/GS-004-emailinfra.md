...
| **Last Verified** | 2026-09-26 against commit `SHA_PLACEHOLDER` — region P&L head Cc (`FN-298`, `CFG-070`; see `## Version / change reference`) |
