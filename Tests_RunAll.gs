 ...
 * runOpsChecklistRunnerTestsNow, runLeadFollowupsStalenessTestsNow) when
 * you only want to check one concern after a change to just that file.
 *
...
function runAllTests() {
  const suites = [
    ...
    runInteractionHistoryLoggerTests_,
