 ...
 * AllIssuesEmailer.gs, RmHierarchy.gs). Nothing here is specific to any
 * one script's own job — it's the "how do we read a lead row and decide
 * what stage it's in" layer every one of them builds on.
 *
 ...
 * RmHierarchy.gs, RmHierarchy.private.gs). File name doesn't matter to
 * Apps Script — only the CONTENT and the project it's in — but naming it
 * to match keeps the Apps Script editor's file list self-explanatory.
 * ================================================================================
 */
